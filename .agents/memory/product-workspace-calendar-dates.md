...
**How to apply:** Return `YYYY-MM-DD`, validate or unambiguously normalize incoming date fields before SQL, and name the failing field in validation errors. Preserve unreadable legacy text separately so unrelated edits remain saveable without silently overwriting it.