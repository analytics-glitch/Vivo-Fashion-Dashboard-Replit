...
The Product Workspace Fabric Stock Mix must remain a read-only presentation of the canonical Fabric BI mix response. Proxy that calculation through an internal-token route; never reimplement consumption, stock, cover, or status logic in the Workspace service.