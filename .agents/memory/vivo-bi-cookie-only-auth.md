...
- Apply this to every transport on standalone pages too: shared fetch helpers, direct mutations, file exports, presence heartbeats, and streamed chat requests.
