...
const AdminL10Migration = React.lazy(() => import("@/pages/AdminL10Migration"));
        ...
        <AuthProvider>
          <FiltersProvider>
            <Routes>
              ...
              <Route path="/admin/l10-migration" element={<ProtectedShell adminOnly pageId="admin-l10-migration"><AdminL10Migration /></ProtectedShell>} />
