  ...
  return (
    <div className="min-h-screen w-full grid place-items-center bg-[#fed7aa] px-4 py-10">
      <div className="bg-white border border-[#fdba74] rounded-2xl shadow-xl max-w-md w-full p-8 text-center">
        <img src="/logo.svg" alt="Vivo Fashion Group" className="h-10 mx-auto mb-5" />
        ...
        <p className="mt-2 text-[13px] text-[#6b7280]">
          ...
          <span className="font-medium text-[#1a5c38]">@vivofashiongroup.com</span>{" "}
          and{" "}
          <span className="font-medium text-[#1a5c38]">@shopzetu.com</span>{" "}
          accounts.
        </p>
        <button
          type="button"
