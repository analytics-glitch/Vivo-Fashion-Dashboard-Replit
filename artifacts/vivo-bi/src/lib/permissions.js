...
const ANALYST = [...VIEWER, "inventory", "re-order", "ibt", "products", "data-quality", "allocations", "replenishments", "marketing", "range-mgmt", "custom-report", "velocity", "size-health", "margin", "rfm"];
