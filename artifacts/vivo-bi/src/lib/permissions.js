...
const PRODUCT_DEVELOPMENT = ["product-analysis", "range-mgmt", "catalogue", "gallery", "style-library", "inventory", "size-health", "data-quality", "fabric", "exports", "production", "production-workspace", "production-report", "style-tracker", "pd-flow", "product-workspace", "partner-brands", "sops", "central-tracker", ..._MERCH_TABS];
...
const PRODUCTION = ["production", "production-workspace", "production-report", "style-tracker", "pd-flow", "fabric", "quality", "sops"];
