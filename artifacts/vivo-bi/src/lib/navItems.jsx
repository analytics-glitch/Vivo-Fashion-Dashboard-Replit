...
export const PRIMARY_NAV = [
  ...
  { to: "/production-wallboard", label: "Production Wallboard", icon: Factory, id: "production-wallboard", group: "Operations & Production", desc: "Live factory-floor wallboard — hourly output vs target and projected end-of-day landing per sewing line" },
