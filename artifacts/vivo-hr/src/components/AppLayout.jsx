...
const NAV = [
  ...
  { to: "/directory", label: "Directory", icon: Contact, roles: ["executive", "hr_manager", "branch_manager"] },
  { to: "/departments", label: "Departments", icon: Network, roles: ["executive", "hr_manager", "branch_manager"] },
