...
function StylesPage() {
  ...
  const styles = useListWorkspaceStyles(styleParams, { query: { queryKey: getListWorkspaceStylesQueryKey(styleParams) }, request: { credentials: 'include' } });
