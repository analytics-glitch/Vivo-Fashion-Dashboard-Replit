    ...
    <div className="p-6 md:p-10 max-w-[1400px] mx-auto" data-testid="customer-profile-page">
      ...
      <Card className="vivo-card p-8 rounded-sm">
        <div className="flex flex-col md:flex-row md:items-center gap-6">
          <div
            className="h-24 w-24 rounded-2xl flex items-center justify-center text-3xl font-display font-semibold shrink-0"
            style={{
              background: "linear-gradient(135deg, #FCEFD9 0%, #F4DCB1 50%, #E7B989 100%)",
              color: "var(--vivo-navy)",
              boxShadow: "inset 0 1px 0 rgba(255,255,255,0.6), 0 1px 2px rgba(15,77,49,0.08)",
            }}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-3 flex-wrap" data-testid="profile-status-row">
              {profile.loyalty_tier && <LoyaltyBadge tier={profile.loyalty_tier} testid="profile-loyalty-tier"/>}
              {profile.rfm_tier && <RfmBadge tier={profile.rfm_tier} />}
              <button
                onClick={() => setAssignOpen(true)}
                className={`text-xs px-2.5 py-1 rounded-sm border press-effect ${assignment.assignee_user_id ? "border-[var(--vivo-navy)] text-[var(--vivo-navy)] bg-white" : "border-dashed border-[var(--vivo-muted)] text-[var(--vivo-muted)]"}`}
            ...
            <div className="mt-4 flex flex-wrap gap-x-5 gap-y-1.5 text-sm text-[var(--vivo-muted)]">
      ...
      {/* Tabs */}
      <Tabs defaultValue="timeline_all" className="mt-10">
        <TabsList className="vivo-pill-tabs flex-wrap max-w-full overflow-x-auto no-scrollbar">
          {[
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <option value="retention">Bridge spend (retain tier)</option>
                  </select>
                  <Button
                    type="button"
                    size="sm"
