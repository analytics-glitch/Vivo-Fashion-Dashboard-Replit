  ...
  return (
    <div className="p-6 md:p-10 max-w-[1400px] mx-auto" data-testid="customer-search-page">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <Link to="/customers/database" className="inline-flex items-center gap-2 h-10 px-4 rounded-sm border border-[var(--vivo-border)] bg-white text-sm text-[var(--vivo-navy)] hover:bg-[var(--vivo-bg-soft)] press-effect" data-testid="open-database">
          Open database table <span className="text-[var(--vivo-muted)]">→</span>
        </Link>
      </div>
